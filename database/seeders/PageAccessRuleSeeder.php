...
class PageAccessRuleSeeder extends Seeder
{
    public function run(): void
    {
        $rules = [
            ...
            ['page_key' => 'simulateur_armes', 'label' => 'Simulateur Armes',           'min_role' => 'prospect',       'description' => 'Outil de calcul de craft et rentabilite armes.',  'sort_order' => 40, 'is_system' => false],
            ['page_key' => 'simulateur_munitions', 'label' => 'Simulateur Munitions',   'min_role' => 'prospect',       'description' => 'Outil de calcul de craft munitions.',             'sort_order' => 50, 'is_system' => false],
            ...
            ['page_key' => 'stocks_generique', 'label' => 'Stocks generiques',          'min_role' => 'officer',        'description' => 'Vue generique des stocks (a venir).',             'sort_order' => 100, 'is_system' => false],
