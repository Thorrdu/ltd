...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['group' => 'cotisations', 'key' => 'cotisation_day',      'label' => 'Jour de cotisation',                'type' => 'string',  'value' => 'monday', 'description' => 'Jour de la semaine pour la cotisation (monday, tuesday, etc.)', 'sort_order' => 4],
